...
use ink::{
    abi::Sol, contract_ref, env::DefaultEnvironment, prelude::string::String, Address, U256,
};
...
pub mod asset_hub_precompile {
    ...
    impl Erc20 for AssetHubPrecompile {
        ...
        fn totalSupply(&self) -> U256 {
            ...
            let precompile: contract_ref!(Erc20, DefaultEnvironment, Sol) =
        ...
        fn transfer(&mut self, to: Address, amount: U256) -> Result<bool, Error> {
            let precompile_address = prefixed_address(PRECOMPILE_INDEX, self.asset_id);
            let mut precompile: contract_ref!(Erc20, DefaultEnvironment, Sol) =
                precompile_address.into();
